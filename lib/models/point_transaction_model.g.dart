...
_$PointTransactionModelImpl _$$PointTransactionModelImplFromJson(
    ...
    _$PointTransactionModelImpl(
      ...
      normalPointsAwarded: (json['normalPointsAwarded'] as num?)?.toInt(),
      specialPointsAwarded: (json['specialPointsAwarded'] as num?)?.toInt(),
...
Map<String, dynamic> _$$PointTransactionModelImplToJson(
    ...
    <String, dynamic>{
      ...
      'normalPointsAwarded': instance.normalPointsAwarded,
      'specialPointsAwarded': instance.specialPointsAwarded,
