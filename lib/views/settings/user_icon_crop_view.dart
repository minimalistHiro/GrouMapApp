...
class UserIconCropView extends StatefulWidget {
  final Uint8List imageBytes;

  const UserIconCropView({
    super.key,
    required this.imageBytes,
  });

  @override
  State<UserIconCropView> createState() => _UserIconCropViewState();
}

class _UserIconCropViewState extends State<UserIconCropView> {
