      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text('改定日: 2026年3月6日', style: _metaStyle),
            ...
            _buildSection(
              title: 'ランキング機能に関する公開情報',
              text: '探検家ランキング機能では、以下の情報がアプリ内で他の利用者に公開されます。',
              bullets: const [
                'ユーザー名（表示名）',
                'プロフィールアイコン画像',
                '発見店舗数（ランキングスコア）',
              ],
              footerText: 'ランキングへの参加はデフォルトでONとなっています。設定 > ランキング設定からOFFにすると、「名無し探検家」として匿名表示されます。OFFにした場合も順位の計算には含まれますが、他の利用者にはユーザー名・プロフィールアイコンが表示されません。',
            ),
