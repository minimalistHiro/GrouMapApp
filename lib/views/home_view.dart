...
import 'menu_views/store_intro_view.dart';
...
class _HomeViewState extends State<HomeView> with TickerProviderStateMixin {
  ...
  // 紹介ボーナス表示済みかを追跡（削除：email_sign_up_view.dartで処理）
  ...
  Future<void> _loadUserData(String userId) async {
    try {
      ...
      // 紹介ボーナス表示チェックは削除（email_sign_up_view.dartで処理）
  ...
  // 紹介ボーナスポップアップはemail_sign_up_view.dartで処理（削除）
      ...
      child: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            ...
            _buildMenuButton('店舗紹介', 'assets/images/store_icon.png', isLogin, isImage: true),
    ...
    return GestureDetector(
      onTap: () {
        ...
        if (title == 'ポイント') {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const StoreIntroView(),
            ),
          );
        } else if (title == '店舗一覧') {
          Navigator.of(context).push(
