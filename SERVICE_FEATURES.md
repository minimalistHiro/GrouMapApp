...
> **最終更新**: 2026-02-19（投稿統一フィード導入・Instagram投稿エンゲージメント有効化・店舗アプリ投稿セクションタイトル統一）
>
...
| **投稿セクション** | Instagram連携店舗のInstagram投稿と未連携店舗の通常投稿を日付順で混合プレビュー表示 |
...
| 機能 | 説明 |
|------|------|
| **バッジ一覧** | ヘッダー右上フィルターでカテゴリ絞り込み可能なバッジグリッド表示（ロック/アンロック表示なし） |
...
| 機能 | 説明 |
|------|------|
| **投稿一覧（統一フィード）** | Instagram連携店舗のInstagram投稿と未連携店舗の通常投稿を日付順で混合表示。3列グリッド（50件ずつ追加読込・最大300件） |
| **投稿詳細** | 画像カルーセル、店舗アイコン+店舗名+投稿日付、タイトル/本文、いいね、コメント一覧/入力（Instagram投稿・通常投稿の両方で利用可能） |
...
| **投稿セクション** | セクションタイトルは「投稿」で統一。Instagram連携済みの場合はInstagram投稿を最新10件表示（動画除外）、未連携の場合は通常投稿を表示 |
...
| **投稿閲覧一覧** | 3列グリッドで投稿を一覧表示（ホーム画面「全て見る」から遷移、通常投稿/Instagram投稿切替） |
| **投稿詳細閲覧** | 画像カルーセル、店舗アイコン+店舗名+投稿日付、いいね数/閲覧数、コメント一覧（閲覧専用） |
