...
> **最終更新**: 2026-02-17（コインシステム追加・10スタンプ特典を任意設定・ポイント制度廃止・紹介施策方針を反映）
>
...
| 機能 | 説明 |
|------|------|
| **分析ダッシュボード** | 月間スタンプ統計（押印数/10スタンプ達成数/特典利用数）、週間・月間統計カードの表示 |
...
| **月間統計** | 訪問者数 / 新規顧客 / 売上 / 客単価 / リピート率 / スタンプ押印数 / 特典利用数 |
...
| **条件タイプ（20種以上）** | チェックイン回数 / 連続日数 / レベル / 会計金額 / 曜日利用 / ジャンル別来店 / 同じ市利用 等 |
| **バッジ編集** | 既存バッジの情報変更 |
