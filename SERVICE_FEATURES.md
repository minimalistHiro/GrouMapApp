...
### コアコンセプト
- 他店舗への送客により新規顧客を増やす（リピーター獲得だけに偏らない）
- 全店舗共通のスタンプ運用でユーザーの回遊を促進
- マップ上で「未訪問/訪問済み/スタンプ達成」が一目でわかるゲーム性
- 大手グルメサービスに埋もれない中小店舗の露出機会を提供
- 店舗の評価機能（★レビュー等）は導入しない方針
...
| **10スタンプ達成特典** | 全店舗で必須設定のスタンプ10個達成時の特典（内容は店舗裁量） |
...
| **クーポン詳細** | ヘッダー画像、概要、期限、割引情報、必要スタンプ数、店舗情報、注意事項を表示 |
| **クーポン取得** | 条件を満たしたクーポンを自動的に取得（重複チェック付き） |
| **クーポン使用** | 会計時にクーポンを使用（トランザクション処理） |
...
| **バッジ条件タイプ** | 累計ポイント / 来店回数 / 連続日数 / QRスキャン数 / 訪問店舗数 / スペシャルイベント 等 |
...
| **無料枠** | 7店舗まで無料 |
| **有料化開始** | 8店舗目の契約から |
| **プラン** | ベーシック / プレミアム の2プラン |

### 料金表

| 店舗数 | ベーシック | プレミアム |
|--------|-----------|-----------|
| 8〜30店舗目 | 2,980円/月 | 4,980円/月 |
| 31〜60店舗目 | 3,980円/月 | 5,980円/月 |
| 61〜100店舗目 | 4,980円/月 | 6,980円/月 |
| 101〜150店舗目 | 5,980円/月 | 8,980円/月 |
...
|--------|------|
| **ベーシック** | 店舗掲載、スタンプ運用 |
| **プレミアム** | ベーシック + 投稿（1日2件まで・最大500字）+ 独自クーポン発行（有効期限内合計3件まで・最低1日〜最長2週間） |
...
| 指標 | 定義 |
|------|------|
| **新規顧客数（主要KPI）** | 店舗ごとの初回スタンプ付与ユーザー数 |
| **リピート率（週次）** | 当週スタンプ付与2回以上のユーザー数 ÷ 当週スタンプ付与1回以上のユーザー数 |
| **リピート率（月次）** | 当月スタンプ付与2回以上のユーザー数 ÷ 当月スタンプ付与1回以上のユーザー数 |
| **未訪問来店率** | 未訪問店舗への初回スタンプ付与ユーザー数 ÷ 全スタンプ付与ユーザー数 |
| **レコメンド経由来店率** | レコメンド経由来店数 ÷ 全スタンプ付与ユーザー数 |
| **10スタンプ達成率** | スタンプ10個達成ユーザー数 ÷ スタンプ付与ユーザー数 |
| **特典利用率** | 10スタンプ特典の利用数 ÷ 10スタンプ達成数 |
| **客単価** | 会計金額合計 ÷ 来店回数 |
| **送客KPI** | 送客数 / インプレッション / 送客率 / 送客売上 / 30日LTV |
