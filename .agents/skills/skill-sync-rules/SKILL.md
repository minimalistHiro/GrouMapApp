...
description: 「スキルを追加して」「スキルを修正して」「スキルを作成して」「スキルを更新して」「スキルを削除して」など、スキルの追加・修正・作成・削除を依頼されたときに、.Codex と .codex の両方、かつユーザー用・店舗用リポジトリの両方に同じ内容を反映するためのルール。
---
...
| # | パス |
|---|------|
| 1 | `/Users/kanekohiroki/Desktop/groumapapp/.Codex/skills/{skill-name}/SKILL.md` |
| 2 | `/Users/kanekohiroki/Desktop/groumapapp/.codex/skills/{skill-name}/SKILL.md` |
| 3 | `/Users/kanekohiroki/Desktop/groumapapp_store/.Codex/skills/{skill-name}/SKILL.md` |
...
- **片方だけの更新は禁止**: `.Codex` のみ、`.codex` のみ、ユーザー用のみ、店舗用のみの更新は行わない。必ず4箇所すべてに同じ内容を反映する。
