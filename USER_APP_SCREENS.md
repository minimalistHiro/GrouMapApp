...
- 構成: タブ表示（トップ/店内/メニュー/投稿）、お気に入り操作、スタンプ状況、トップタブは店舗名/店舗アイコンと店舗説明を同一の白背景内に表示、クーポン一覧（利用可能のみ）と投稿プレビュー（新着15件・3列グリッド）を表示、投稿グリッド下部の「全て見る＞」ボタンで上部タブ「投稿」へ遷移、投稿タブはInstagram投稿グリッド（動画除外・最新50件）
